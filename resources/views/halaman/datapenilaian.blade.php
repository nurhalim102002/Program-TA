                                    ...
                                    <div class="card-body">
                                        <div class="wadah-filter">
                                            ...
                                            <div class="formulir-filter">
                                                ...
                                                <form method="GET" action="{{ url('/cetakranking') }}" class="d-flex align-items-center gap-3">
                                                    <input type="hidden" name="periode" value="{{ request('periode') }}">
                                                    <button type="submit" class="btn btn-info btn-print">Cetak</button>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        <table id="datatable" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/cetaknilaiindividu/' . $item->karyawan->id . '/' . $item->periode) }}" class="btn btn-info btn-sm" target="_blank">Cetak</a>
