                                ...
                                <div class="col-xl-12">
                                    <div class="card m-b-30">
                                        <div class="card-body bootstrap-select-1">
                                            <h4 class="header-title mt-0">Form Tambah Data Penugasan</h4>
                                            <p class="text-muted font-14">Silahkan input Data Penugasan dengan benar!!</p>                                        
                                            <form action="{{ url('simpansp') }}" method="POST">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Masa Berlaku" id="masa_berlaku" name="masa_berlaku">
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Perihal</h6>
                                                        <input type="text" class="form-control" placeholder="Perihal" id="perihal" name="perihal">
                                                    </div>
                                                </div>
                                                <br>
