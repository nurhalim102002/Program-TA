                                ...
                                <div class="col-xl-12">
                                    <div class="card m-b-30">
                                        <div class="card-body bootstrap-select-1">
                                            <h4 class="header-title mt-0">Form Edit Data Admin</h4>
                                            <p class="text-muted font-14">Silahkan input Data Admin dengan benar!!</p>                                        
                                            <form action="{{ url('perubahanadmin/'.$adm->id) }}" method="POST">
                                            {{ csrf_field() }}
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" id="id_karyawan" name="id_karyawan" onchange="updateJabatan()">
                                                            ...
                                                            @foreach($kry as $item)
                                                                <option value="{{$item->id}}" data-jabatan-id="{{ optional($item->jabatan)->id }}" data-jabatan="{{ optional($item->jabatan)->jabatan }}" {{ $item->id == $adm->id_karyawan ? 'selected' : '' }}>{{$item->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" id="id_jabatan" name="id_jabatan">
                                                            <!-- Terisi Otomatis -->
                                                            <option value="{{ $adm->id_jabatan }}" selected>{{ $adm->jabatan->jabatan }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" id="level" name="level">
                                                            ...
                                                            <option value="Admin" {{ $adm->level == 'Admin' ? 'selected' : '' }}>Admin</option>
                                                            <option value="Penilai" {{ $adm->level == 'Penilai' ? 'selected' : '' }}>Penilai</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="email" class="form-control" placeholder="Email" id="email" name="email" value="{{ $adm->email }}">
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Password</h6>
                                                        <input type="password" class="form-control" placeholder="Password" id="password" name="password" value="{{ $adm->password }}">
                                                    </div>
                                                </div>
                                                <br>
                                                <br>
