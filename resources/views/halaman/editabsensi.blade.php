...
<head>
    ...
    <title>Minamas - Tambah Edit Absensi</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="{{url('dataabsensi')}}">Data Absensi</a></li>
                                ...
                                <div class="col-xl-12">
                                    <div class="card m-b-30">
                                        <div class="card-body bootstrap-select-1">
                                            <h4 class="header-title mt-0">Form Edit Data Absensi</h4>
                                            <p class="text-muted font-14">Silahkan input Data Admin dengan benar!!</p>                                        
                                            <form action="{{ url('perubahanabsensi/'.$abs->id) }}" method="POST">
                                            {{ csrf_field() }}
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" id="id_karyawan" name="id_karyawan" disabled>
                                                            ...
                                                            @foreach($kry as $item)  
                                                            <option value="{{$item->id}}" {{ $item->id == $abs->id_karyawan ? 'selected' : '' }}>{{$item->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                        <!-- Hidden input to ensure the ID is sent -->
                                                        <input type="hidden" name="id_karyawan" value="{{ $abs->id_karyawan }}">
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Mangkir</h6>
                                                        <input type="text" class="form-control" placeholder="Mangkir" id="mangkir" name="mangkir" value="{{ $abs->mangkir }}">
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Izin / P1</h6>
                                                        <input type="text" class="form-control" placeholder="Izin atau P1" id="izin_p1" name="izin_p1" value="{{ $abs->izin_p1 }}">
                                                    </div>
                                                </div>
                                                <br>
