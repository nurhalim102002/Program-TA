...
<head>
    ...
    <title>Urora - Tambah Data Absensi</title>
                                ...
                                <div class="col-xl-12">
                                    <div class="card m-b-30">
                                        <div class="card-body bootstrap-select-1">
                                            <h4 class="header-title mt-0">Form Tambah Data Absensi</h4>
                                            <p class="text-muted font-14">Silahkan input Data Admin dengan benar!!</p>                                        
                                            <form action="{{ url('simpanabsensi') }}" method="POST">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Mangkir" id="mangkir" name="mangkir">
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Izin / P1</h6>
                                                        <input type="text" class="form-control" placeholder="Izin atau P1" id="izin_p1" name="izin_p1">
                                                    </div>
                                                </div>
                                                <br>
