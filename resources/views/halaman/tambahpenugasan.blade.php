...
<head>
    ...
    <title>Urora - Tambah Data Penugasan</title>
                                ...
                                <div class="col-xl-12">
                                    <div class="card m-b-30">
                                        <div class="card-body bootstrap-select-1">
                                            ...
                                            <form action="{{ url('simpanpenugasan') }}" method="POST">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Periode Penugasan" id="periode_penugasan" name="periode_penugasan">
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Lokasi / Jabatan</h6>
