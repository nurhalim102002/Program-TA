...
<head>
    ...
    <title>Urora - Tambah Data SP</title>
                                ...
                                <div class="col-xl-12">
                                    <div class="card m-b-30">
                                        <div class="card-body bootstrap-select-1">
                                            ...
                                            <form action="{{ url('perubahansp/'.$sp->id) }}" method="POST">
                                            {{ csrf_field() }}
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" id="id_karyawan" name="id_karyawan">
                                                            ...
                                                            @foreach($kry as $item)  
                                                            <option value="{{$item->id}}" {{ $item->id == $sp->id_karyawan ? 'selected' : '' }}>{{$item->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" id="sp_ke" name="sp_ke">
                                                            <option selected disabled>Pilih</option>
                                                            <option value="1" {{ $sp->sp_ke == 1 ? 'selected' : '' }}>1</option>
                                                            <option value="2" {{ $sp->sp_ke == 2 ? 'selected' : '' }}>2</option>
                                                            <option value="3" {{ $sp->sp_ke == 3 ? 'selected' : '' }}>3</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Masa Berlaku</h6>
                                                        <input type="text" class="form-control" placeholder="Masa Berlaku" id="masa_berlaku" name="masa_berlaku" value="{{ $sp->masa_berlaku }}">
                                                    </div>
                                                </div>
                                                <div class="row form-material">
                                                    <div class="col-md-12">
                                                        <h6 class="text-muted">Perihal</h6>
                                                        <input type="text" class="form-control" placeholder="Perihal" id="perihal" name="perihal" value="{{ $sp->perihal }}">
                                                    </div>
                                                </div>
                                                <br>
